<?php
$response = array();
if(isset($_POST['nomerec']) && isset($_POST['preparo']) && isset($_POST['sobre']) && isset($_POST['ingrediente']) && isset($_FILES['imagem'])){
...
$result = pg_query($con, "INSERT INTO receita (nomerec, sobre, preparo, ingredientes,imagem) VALUES ('$nomerec','$sobre','$preparo','$ingredientes', '$imagem');");
if($result){
    $response["success"] = 1;
